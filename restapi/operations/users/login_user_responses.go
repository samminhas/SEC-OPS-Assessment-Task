...
/*LoginUserOK Sucessfull Registeration
...
type LoginUserOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.LoginSuccessResponseDefinition `json:"body,omitempty"`
}
...
func (o *LoginUserOK) WithPayload(payload *models.LoginSuccessResponseDefinition) *LoginUserOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the login user o k response
func (o *LoginUserOK) SetPayload(payload *models.LoginSuccessResponseDefinition) {
	o.Payload = payload
}
