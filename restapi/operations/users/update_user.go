...
/*UpdateUser swagger:route PUT /updateUser Users updateUser

updating the users details in the database

To update a new user in to the mysql server installed in my local machine
