...
type UpdateUserParams struct {
	...
	/*
	  ...
	  In: body
	*/
	UpdateUserBody *models.UpdateUsersDefinition
}
...
func (o *UpdateUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.UpdateUsersDefinition
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("updateUserBody", "body", ""))
			} else {
				res = append(res, errors.NewParseError("updateUserBody", "body", "", err))
			}
		} else {
